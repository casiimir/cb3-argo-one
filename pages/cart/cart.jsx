				...
				<div className={styles.Container}>
					<div className={styles.Container__Cart}>
						...
						{cart &&
							cart.cartItems.map((item, index) => (
								<div
									className={styles.Container__Cart__Item}
									key={index}
								>
									<div className={styles.Bagde}>
										<div className={styles.ImgContainer}>
										...
										<div className={styles.Container_Info}>
											...
											>
												<BsFillBagCheckFill
													className={
														styles.Wrapper_title__Bookmark
													}
												/>
												<p
													className={
														styles.Wrapper_title__titleP
													}
												>
													{item.title
														.split(" ")
											...
											>
												<ImPriceTag
													className={
														styles.Wrapper_Price__PriceTag
													}
												/>
												<p
													className={
														styles.Wrapper_Price__text
													}
												>
													{item.price}
												</p>
									...
									<div className={styles.Container_count}>
										<div className={styles.Wrapper_Counter}>
											...
											<input
												...
												value={item.packs.length}
												className={
													styles.Wrapper_Counter__Input
												}
											/>
											<button
												className={
													styles.Cart_Button__Plus
												}
												onClick={() =>
													handleClickonPlus(
														item.title
					...
					<div className={styles.Wrapper_Total}>
						<div className={styles.Wrapper_Total__Container}>
							<h3
								className={
									styles.Wrapper_Total__Container__title
								}
							>
								Total
							</h3>
							<p
								className={
									styles.Wrapper_Total__Container__text
								}
							>
								$ {cart.cartTotal}
							</p>
